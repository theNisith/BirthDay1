...
function initializeMazeGame() {
    ...
    if (!mazeGame.canvas) {
        console.log('Maze canvas not found');
        return;
    }
    ...
    mazeGame.canvas.style.width = size + 'px';
    mazeGame.canvas.style.height = size + 'px';
    mazeGame.cellSize = size / mazeGame.rows;
    
    console.log('Maze initialized with size:', size);
...
const heartMessages = [
    "Your laugh is contagious. Like, genuinely makes my day better.",
    "The way you get excited about biology — it's actually pretty cute.",
    "You're stronger than you think. Especially with A/Ls coming up.",
    "I like how real you are. No pretending, just you.",
    "Your camping stories? I could listen to them all day.",
    "You have this energy that makes people want to be around you.",
    "The way you light up when talking about girl scouts — it's genuine passion.",
    "You're smart. Like really smart. Don't doubt yourself.",
    "I admire how you balance studying and still make time for what you love.",
    "Honestly? You're pretty amazing. Just thought you should know."
];
...
function createHearts() {
    const container = document.getElementById('heartsGrid');
    container.innerHTML = '';
    ...
    heartMessages.forEach((message, index) => {
        ...
        heartItem.innerHTML = `
            <div class="heart-card">
                <div class="heart-front">
                    ...
                    <div class="heart-number">#${index + 1}</div>
                </div>
        ...
        heartItem.onclick = function() {
            if (!this.classList.contains('flipped')) {
                ...
                // Show final message when all hearts are revealed
                if (revealedCount === heartMessages.length) {
...
function showFinalMessage() {
    ...
    messageDiv.innerHTML = `
        ...
        <p>There's a lot more I could say, but I wanted to keep it real. 
        You're pretty special, and I'm glad I get to know you.</p>
    `;
...
function createHeartBurst() {
    ...
    for (let i = 0; i < 20; i++) {
        setTimeout(() => {
            ...
            heart.style.animation = 'heartBurstOut 2s ease-out forwards';
...
// Smooth scroll to adventures section
function scrollToAdventures() {
    document.getElementById('adventures').scrollIntoView({ 
        behavior: 'smooth',
        block: 'start'
    });
}
